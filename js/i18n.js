(function () {
  ...
  const messages = {
    zh: {
      ...
      "Visualisez le parcours scolaire et la répartition des sept établissements dans Rennes.": "同时查看七个教学点的升学路径与雷恩校区分布。",
      "Le parcours des 7 pôles SIC": "七个 SIC 教学点升学路径",
      "Quatre écoles primaires mènent à deux collèges, puis à un même lycée.": "四所小学分别升入两所初中，最后汇入同一所高中。",
      "Arbre du parcours des sept pôles SIC": "七个 SIC 教学点升学树状图",
      "Écoles primaires (4)": "小学（4所）",
      "Collèges (2)": "初中（2所）",
      "Lycée (1)": "高中（1所）",
    ...
    en: {
      ...
      "Visualisez le parcours scolaire et la répartition des sept établissements dans Rennes.": "See the progression pathway and the location of all seven schools across Rennes.",
      "Le parcours des 7 pôles SIC": "The 7-site SIC pathway",
      "Quatre écoles primaires mènent à deux collèges, puis à un même lycée.": "Four primary schools feed into two middle schools, then one shared high school.",
      "Arbre du parcours des sept pôles SIC": "Progression tree for the seven SIC sites",
      "Écoles primaires (4)": "Primary schools (4)",
      "Collèges (2)": "Middle schools (2)",
      "Lycée (1)": "High school (1)",
